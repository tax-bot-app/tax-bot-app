...
export const TOPIC_SPECS: TopicSpec[] = [
  {
    ...
    patterns: [
      ...
      { re: /(謝礼|協力費|協賛金|賛助金)/, score: 6 },

      // =========================
      // ★ 37.2：現実質問（領収書なし／現金手渡し／近隣／夜の店プレゼント）
      // =========================
      { re: /(近隣(対策|挨拶)|近隣対策費|迷惑料|菓子折り|手渡し|現金|現金謝礼|謝礼|心付け|寸志)/, score: 11 },
      { re: /(領収書(なし|無し)|領収書なし|領収書無し)/, score: 11 },
      { re: /(不動産(屋|会社|業者)|仲介).*(謝礼|心付け|寸志|現金|手渡し|領収書(なし|無し)|領収書なし)/, score: 12 },
      { re: /(飲み屋|接待|会食|同伴|アフター|ホステス|キャバ|キャバクラ|クラブ|ラウンジ|スナック|ニュークラブ|セクキャバ|風俗|ソープ|メンエス|メンズエステ|嬢)/, score: 10 },
      { re: /(飲み屋|接待|会食|同伴|アフター|ホステス|キャバ|キャバクラ|クラブ|ラウンジ|スナック|ニュークラブ|セクキャバ|風俗|ソープ|メンエス|メンズエステ|嬢|飲み屋).*(プレゼント|贈り物|ブランド|バッグ|時計|アクセ|指輪|シャンパン|ボトル)/, score: 12 },
      { re: /(プレゼント|贈り物|ブランド|バッグ|時計|アクセ|指輪|シャンパン|ボトル)/, score: 7 },
      { re: /(お詫び|謝罪|詫び)/, score: 6 },
